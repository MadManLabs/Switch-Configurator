...
public class Service {
	...
	public static ResultData save(ConfigurationData userinput, String filename){
		...
		try {
			...
			feedback.setErrorMessage(FileHandler.delOldOutputFileAndwriteOutputToFile(filename, output));
		} catch (Exception ex) {
	...
	public static ResultData saveConfigToFile(ConfigurationData userinput, String file) {
		...
		try {
			...
			FileHandler.delOldOutputFileAndwriteOutputToFile(file, output.toString());
