...
public class ConfigurationData {
	...
	public ConfigurationData(){
		...
		EthernetInfos = new DictionaryMap<>();
		
		// Als default VLAN wird VLAN1 zu beginn zum Dictionary hinzugef�gt
		VlanInfos = new DictionaryMap<>();
	...
	public void setIpSwitchToJson(IpSwitchInfoData ipSwitch, String fileName) throws JsonSyntaxException, JsonIOException, IOException {
		...
		FileHandler.replaceOldOutputToFile(fileName, output.toString());
	}
